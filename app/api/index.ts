...
export async function searchResults({
  ...
  return await fetchFn({
    url: `https://api.themoviedb.org/3/search/multi?query=${newValue}&page=${clampedPage}`,
  });
}
...
// Movies Pages Lists
export async function fetchMoviesLists({
  listType,
  pageNum,
}: {
  listType: string;
  ...
  return Promise.all(
    listType === "Trending"
      ? [
          fetchFn({
            url: `https://api.themoviedb.org/3/trending/movie/day?page=${clampedPage}`,
          }),
        ]
      : listType === "AllMovies"
        ? [
            fetchFn({
              url: `https://api.themoviedb.org/3/discover/movie?page=${clampedPage}`,
            }),
          ]
        : [
            fetchFn({
              url: `https://api.themoviedb.org/3/movie/${listType}?page=${clampedPage}`,
            }),
          ],
  );
}
...
// Shows Details
export async function fetchShowsLists({
  listType,
  pageNum,
}: {
  listType: string;
  ...
  return Promise.all(
    listType === "Trending"
      ? [
          fetchFn({
            url: `https://api.themoviedb.org/3/trending/tv/day?page=${clampedPage}`,
          }),
        ]
      : listType === "AllShows"
        ? [
            fetchFn({
              url: `https://api.themoviedb.org/3/discover/tv?page=${clampedPage}`,
            }),
          ]
        : [
            fetchFn({
              url: `https://api.themoviedb.org/3/tv/${listType}?page=${clampedPage}`,
            }),
          ],
  );
}
...
export async function fetchShowRecommend({ ShowId }: { ShowId: number }) {
  return await fetchFn({
    url: `https://api.themoviedb.org/3/tv/${ShowId}/similar`,
  });
}
export async function fetchShowSimilar({ ShowId }: { ShowId: number }) {
  return await fetchFn({
    url: `https://api.themoviedb.org/3/tv/${ShowId}/recommendations`,
  });
}
...
export async function fetchSeasonDetails({
  ...
  return await fetchFn({
    url: `https://api.themoviedb.org/3/tv/${ShowId}/season/${seasonNum}`,
  });
}
...
export async function fetchSeasonCast({
  ...
  return await fetchFn({
    url: `https://api.themoviedb.org/3/tv/${ShowId}/season/${seasonNum}/credits`,
  });
}
...
export async function fetchEpisodeDetails({
  ...
  return await fetchFn({
    url: `https://api.themoviedb.org/3/tv/${ShowId}/season/${seasonNum}/episode/${episodeNum}`,
  });
}
...
export async function fetchEpisodeCast({
  ...
  return await fetchFn({
    url: `https://api.themoviedb.org/3/tv/${ShowId}/season/${seasonNum}/episode/${episodeNum}/credits`,
  });
}
...
export async function fetchPeopleLists({
  ...
  if (listType === "Trending") {
    return [
      await fetchFn({
        url: `https://api.themoviedb.org/3/trending/person/day?page=${clampedPage}`,
      }),
    ];
  } else if (listType === "popular") {
    return [
      await fetchFn({
        url: `https://api.themoviedb.org/3/person/popular?page=${clampedPage}`,
      }),
    ];
  }
