  ...
  return (
    <>
      ...
      <div className="relative mb-12">
        <GridContainer
          className="glass-dark rounded-3xl items-center md:grid-cols-3 shadow-2xl shadow-fuchsia-500/20 p-8 gap-8 border border-gray-700/30"
          cols={1}
        >
      ...
      {/* All Seasons Skeleton */}
      <div className="mb-8">
        <Skeleton className="h-8 w-48 mx-auto mb-6" />
        <div className="glass-dark rounded-2xl py-8 px-8 shadow-xl">
          <div className="flex gap-5 overflow-hidden">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex-shrink-0" style={{ width: 'calc((100% - 80px) / 5)' }}>
